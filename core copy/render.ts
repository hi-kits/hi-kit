...
let INTERNAL_PROPS: {[x: string]: any;} = {
    shadowDom: 1,
    staticNode: 1,
    cloneNode: 1,
    children: 1,
 ...
 */
export function RENDER(this: any, node: any, id: symbol | undefined, hydrate: any) {
 ...
 * @param  {...any} args
 */
export function h(type: any, p: any, ...args: any) {
 ...
 * @returns {Element}
 */
function diff(newVnode: any, node: any, id = ID, hydrate: boolean, isSvg?: boolean) {
    let isNewNode;
 ...
 * @returns {Fragment}
 */
function createFragment(parent: Element, hydrate: boolean) {
 ...
 * @param {boolean} [isSvg]
 */
export function renderChildren(children: any, fragment: any, parent: any, id: any, hydrate: boolean, isSvg?: boolean) {
    children =
    ...
    removeNodes && removeNodes.forEach((node: any) => node.remove());
 ...
 **/
export function diffProps(node: any, props: any, nextProps: any, handlers: any, isSvg: any) {
 ...
 */
export function setProperty(node: any, key: string, prevValue: any, nextValue: any, isSvg: boolean, handlers: any) {
 ...
 * @param {Handlers} [handlers]
 */
export function setEvent(node: any, type: string, nextHandler: any, handlers: any) {
    // add handleEvent to handlers
    if (!handlers.handleEvent) {
        /**
         * {@link https://developer.mozilla.org/es/docs/Web/API/EventTarget/addEventListener#The_value_of_this_within_the_handler}
         **/
        handlers.handleEvent = (event: { type: string | number; }) =>
 ...
 * @param {string} value
 */
export function setPropertyStyle(style: any, key: string, value: any) {
