...
import { HIElementDefinition } from "./hi-definitions";
...
export class Controller extends PropertyChangeNotifier {
     ...
     */
    private readonly $hiController = this;
     ...
     */
    public readonly definition: HIElementDefinition;
     ...
     * @internal
     */
    public constructor(element: HTMLElement, definition: HIElementDefinition) {
        super(element);
    ...
    public static forCustomElement(element: HTMLElement): Controller {
        const controller: Controller = (element as any).$hiController;
        ...
        return ((element as any).$hiController = new Controller(element, definition));
    }
}
