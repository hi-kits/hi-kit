...
custom_edit_url: https://github.com/microsoft/hi/edit/master/packages/web-components/hi-element/docs/guide/declaring-templates.md
description: While you can create and update nodes in the Shadow DOM manually, HIElement provides a streamlined templating system for the most common rendering scenarios.
---
