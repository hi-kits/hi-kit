...
const updateQueue = $global.HI.getById(KernelServiceId.updateQueue, () => {
...
/* eslint-disable */
const hiHTMLPolicy: TrustedTypesPolicy = $global.trustedTypes.createPolicy(
    "hi-html",
    {
...
let htmlPolicy: TrustedTypesPolicy = hiHTMLPolicy;
